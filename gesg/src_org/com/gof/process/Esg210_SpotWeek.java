...
//		log.info("dateSet: {}", dateSet.size());		
		...
		List<IrCurveSpotWeek> rstList =  curveHisList.stream().map(s-> s.convertToWeek()).collect(Collectors.toList());
...
//	protected static IrCurveWeek cloneEntity(IrCurveWeek sourceEntity) throws CloneNotSupportedException {
//		
//		IrCurveWeek cloneEntity = sourceEntity.clone();
//		return cloneEntity;				
//	}
