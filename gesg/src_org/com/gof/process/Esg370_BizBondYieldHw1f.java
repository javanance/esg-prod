...
@Slf4j
public class Esg370_BizBondYieldHw1f extends Process {
	
	public static final Esg370_BizBondYieldHw1f INSTANCE = new Esg370_BizBondYieldHw1f();
...
//				log.info("seedNum: {}, {}", seedNum, bssd);		
				...
				List<StdAsstIrSceSto>  bondYieldList = bondYield.stream().map(s -> s.convert(applBizDv, irCurveId, irCurveSceNo.toString(), jobId)).collect(Collectors.toList());
