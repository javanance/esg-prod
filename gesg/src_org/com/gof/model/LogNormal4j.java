...
public class LogNormal4j {
	...
	public LogNormal4j(String baseYymm, Map<Integer, Double> driftMap, Map<Integer, Double> sigmaMap, int tenorSize, int batchNum, int seedNum) {
		this.baseYymm = baseYymm;
